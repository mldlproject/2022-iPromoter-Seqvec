...
def train(epoch, model, criteron, optimizer, device, training_loader, time_count=False):
    ...
    duration = end - start
    if time_count:
        print("Average time for training one epoch: {}".format(duration))
    #-------------------------
...
def validate(epoch, model, criteron, device, validation_loader, time_count=False):
    ...
    duration = end - start
    if time_count:
        print("Average time for validation: {}".format(duration))
    #-------------------------
...
def test(epoch, model, criteron, device, test_loader, time_count=False):
    ...
    duration = end - start
    if time_count:
        print("Average time for testing: {}".format(duration))
    #-------------------------
